...
pub static BUTTONS: &'static [(&'static str, Button)] = &[
    (
        "Prev",
        Button::new_on_bot_panel(-BUTTON_WIDTH, LEFT_TRIANGLE),
    ),
    ("Restart", Button::new_on_bot_panel(0.0, TOP_TRIANGLE)),
    (
        "Next",
        Button::new_on_bot_panel(BUTTON_WIDTH, RIGHT_TRIANGLE),
    ),
];
...
const LEFT_TRIANGLE: Triangle = Triangle {
    p1: Point {
        x: -BUTTON_WIDTH - ICON_WIDTH,
        y: BUTTON_Y_POS,
    },
    p2: Point {
        x: -BUTTON_WIDTH + ICON_WIDTH,
        y: BUTTON_Y_POS - ICON_WIDTH,
    },
    p3: Point {
        x: -BUTTON_WIDTH + ICON_WIDTH,
        y: BUTTON_Y_POS + ICON_WIDTH,
