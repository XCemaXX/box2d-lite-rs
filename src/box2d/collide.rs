...
fn clip_segment_to_line(v_out: &mut [ClipVertex; MAX_CONTACT_POINT], v_in: [ClipVertex; MAX_CONTACT_POINT],
    normal: &Vec2, offset: f32, clip_edge: EdgeNumbers) -> usize 
{
...
fn compute_incident_edge(c: &mut [ClipVertex; MAX_CONTACT_POINT], h: &Vec2, pos: &Vec2,
    rot: &Mat22, normal: &Vec2) 
{
